...
@SerialVersionUID(1L)
class IndexLabelAlphabetNotThreadsafe extends Serializable {
...
object IndexLabelAlphabetNotThreadsafe {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val alphabet = new IndexLabelAlphabetNotThreadsafe () 
