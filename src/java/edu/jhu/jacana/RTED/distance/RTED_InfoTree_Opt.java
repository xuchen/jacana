...
package edu.jhu.jacana.RTED.distance;

import java.util.ArrayList;
import java.util.Arrays;

import edu.jhu.jacana.RTED.util.LabelDictionary;
import edu.jhu.jacana.RTED.util.LblTree;
...
public class RTED_InfoTree_Opt {
    ...
    private static final byte RPOST2_RLD = 11; // reversed postorder 2 right-most leaf descendants
