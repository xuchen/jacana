...
import edu.jhu.jacana.reader.MstReaderMemoizable;
 ...
 *
 */
public class TestMstXmlMemoizable {
		...
		try {
			...
			while ((line = in.readLine()) != null) {
				...
				if (line.startsWith("</QApairs")) {
				    ...
				    try {
					    DependencyTree tree = MstReaderMemoizable.read(line, pos_line, lab_line, deps_line, ner_line, ans_line, false, true);
				    } catch (Exception e) {
				    	e.printStackTrace();
