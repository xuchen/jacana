...
//      System.out.println("Matrix "+M.size()+" "+M.columns()+ " "+logMult.cnt);
    ...
    public static DoubleMatrix1D Mult(DoubleMatrix2D M, DoubleMatrix1D y, DoubleMatrix1D z, double alpha, double beta, boolean transposeA, EdgeGenerator edgeGen) {
        // z = alpha * M * y + beta*z
